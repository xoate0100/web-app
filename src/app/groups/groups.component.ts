...
@Component({
    ...
    imports: [MatCard, LayoutDirective, LayoutAlignDirective, MatFormField, MatInput, ReactiveFormsModule, MatCheckbox, LayoutGapDirective, MatButton, RouterLink, FaIconComponent, HasPermissionDirective, MatTable, MatSort, MatColumnDef, MatHeaderCellDef, MatHeaderCell, MatSortHeader, MatCellDef, MatCell, NgClass, ClassDirective, MatHeaderRowDef, MatHeaderRow, MatRowDef, MatRow, MatPaginator, AsyncPipe, StatusLookupPipe]
})
