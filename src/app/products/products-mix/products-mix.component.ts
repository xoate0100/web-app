...
@Component({
    ...
    imports: [LayoutDirective, LayoutAlignDirective, HasPermissionDirective, MatButton, RouterLink, FaIconComponent, LayoutGapDirective, MatFormField, FlexDirective, MatLabel, MatInput, MatTable, MatSort, MatColumnDef, MatHeaderCellDef, MatHeaderCell, MatSortHeader, MatCellDef, MatCell, MatHeaderRowDef, MatHeaderRow, MatRowDef, MatRow, MatPaginator]
})
