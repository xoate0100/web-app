...
@Component({
    ...
    imports: [ReactiveFormsModule, LayoutDirective, LayoutAlignDirective, LayoutGapDirective, MatFormField, FlexDirective, MatInput, MatButton, FaIconComponent, MatList, NgFor, MatListItem, MatLine, DatePipe]
})
