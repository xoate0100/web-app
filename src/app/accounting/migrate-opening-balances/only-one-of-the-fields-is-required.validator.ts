...
export const onlyOneOfTheFieldsIsRequiredValidator: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
  const glAccountEntriesForm = control as FormGroup;
