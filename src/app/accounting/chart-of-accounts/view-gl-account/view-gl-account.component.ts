...
@Component({
    ...
    imports: [LayoutDirective, LayoutAlignDirective, LayoutGapDirective, HasPermissionDirective, NgIf, MatButton, RouterLink, FaIconComponent, MatCard, MatCardContent, FlexDirective]
})
