...
@Component({
    ...
    imports: [FaIconComponent, LayoutDirective, LayoutAlignDirective, NgIf, MatButton, MatTable, MatColumnDef, MatHeaderCellDef, MatHeaderCell, MatCellDef, MatCell, HasPermissionDirective, MatTooltip, MatHeaderRowDef, MatHeaderRow, MatRowDef, MatRow, RouterLink, DatePipe]
})
