...
export const environment = {
  ...
  baseApiUrl: JSON.parse(localStorage.getItem('mifosXServerURL') ?? 'null') || 'https://demo.fineract.dev',  // For connecting to server running elsewhere update the base API URL
